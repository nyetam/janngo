...
export default function SecretariatDashboard() {
  ...
  // Compteurs sur toute la liste (pas filtrée) pour les indicateurs globaux
  ...
  // Requêtes à traiter dans la période sélectionnée
                ...
                {aTraiter.slice(0, 8).map((r) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-gray-400">{r.documents?.length || 0} doc(s)</span>
