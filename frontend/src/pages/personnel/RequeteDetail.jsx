...
export default function RequeteDetail() {
  ...
  return (
    <Layout title="Détail de la requête">
      <main className="flex-1 p-4 md:p-6 max-w-4xl mx-auto w-full space-y-5">
        ...
        <div className="card">
          ...
          <DocumentsPanel documents={requete.documents || []} onDocumentUpdated={charger} />
        </div>
            ...
            {requete.historique?.map((h, i) => (
              <div key={h.id} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < (requete.historique?.length ?? 0) - 1 && <div className="w-0.5 bg-gray-200 flex-1 mt-1" />}
                </div>
                <div className="pb-3">
