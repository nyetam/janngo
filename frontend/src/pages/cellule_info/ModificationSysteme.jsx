...
export default function ModificationSysteme() {
  ...
  // Cellule Info traite les requêtes VALIDEES
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar title="Modifications système" />
              ...
              <div key={r.id} className="card space-y-3">
                    ...
                    <div className="min-w-0">
                      ...
                      {r.type === 'CONTESTATION_NOTE' && r.contestationNote && (
                        <div className="mt-2 p-3 bg-purple-50 border border-purple-200 rounded-xl space-y-1">
                          ...
                          {r.contestationNote.decisionDepartement && (
                            <p className="text-xs text-gray-500 italic">{r.contestationNote.decisionDepartement}</p>
                          )}
                        </div>
                      )}
                ...
                {selected?.id === r.id && (
                  <div className="border-t pt-4 -mx-6 px-6 pb-4 bg-indigo-50/40 rounded-b-xl space-y-3">
                    ...
                    {/* Pour contestation, si pas de note corrigée encore */}
