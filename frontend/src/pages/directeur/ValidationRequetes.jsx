...
export default function ValidationRequetes() {
  ...
  // Directeur traite uniquement CORRECTION_NOM EN_COURS (transmises par secrétariat)
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar title="Validation — Corrections de nom" />
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2 flex-shrink-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => { setSelected(r); setDecision('APPROUVE'); setMotif(''); setMsg(null); }}
