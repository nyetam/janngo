...
export default function DirecteurDashboard() {
  ...
  // Workflow : Dir. reçoit CORRECTION_NOM avec statut EN_COURS (transmis par secrétariat)
  const aValider = liste.filter((r) => r.type === 'CORRECTION_NOM' && r.statut === 'EN_COURS');
  // Validées et rejetées séparément par le Directeur
