...
export default function DirecteurAdjointDashboard() {
  ...
  // À orienter : ATTESTATION EN_COURS sans serviceTraitant encore renseigné
  const aOrienter = liste.filter((r) =>
    r.type === 'ATTESTATION' && r.statut === 'EN_COURS' && !r.attestation?.serviceTraitant
  );
  // Orientées : ATTESTATION avec serviceTraitant renseigné (peu importe le statut final)
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar title="Direction Adjointe" />
