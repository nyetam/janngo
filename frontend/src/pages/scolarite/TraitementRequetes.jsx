...
export default function TraitementRequetesScol() {
  ...
  return (
    <Layout title="Traitement attestations">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3 mt-1 flex-wrap">
                      {[['FAVORABLE', '✅ FAVORABLE'], ['DEFAVORABLE', '❌ DÉFAVORABLE']].map(([val, label]) => (
                        <label key={val} className={`flex-1 flex items-center gap-2 p-3 rounded-xl border-2 cursor-pointer transition-colors min-w-32 ${
                          decision === val
